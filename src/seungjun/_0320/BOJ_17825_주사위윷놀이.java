...
//				System.out.println(Arrays.toString(sel) + " " + " " + result1);
				if (curPos1[result1][1] == 0) {
					curPos1[result1][1] = 1;
					total += curPos1[result1][0];
				} else if (curPos1[result1][1] != 0) {
					total = 0;
					break;
				}
